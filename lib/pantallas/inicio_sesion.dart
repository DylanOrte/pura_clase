            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  EntradaDeTextoIs(pista: "Ingrese su nombre", controlador: controladorNombre, contrasena: false, caracteresMax: 20,),
                  Texto_Is(texto: "Correo electrónico:"),
                  EntradaDeTextoIs(pista: "Ingrese su correo electronico", controlador: controladorCorreo, contrasena: false, caracteresMax: 60,),
                  Texto_Is(texto: "Contraseña:"),
                  EntradaDeTextoIs(pista: "Ingrese su contraseña", controlador: controladorContrasena, contrasena: true, caracteresMax: 40,),
                  Texto_Is(texto: "Confirmar contraseña:"),
                  EntradaDeTextoIs(pista: "Confirme su contraseña", controlador: controladorConfirmarContrasena, contrasena: true,caracteresMax: 40,),
                  SizedBox(height: 5),
